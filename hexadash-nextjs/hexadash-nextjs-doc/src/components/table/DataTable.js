...
const DataTable = ({ filterOption, filterOnchange, rowSelection, tableData, columns }) => {
            ...
            <div className="ninjadash-datatable-filter">
                {
                    ...
                    <div className="ninjadash-datatable-filter__left">
                        ...
                        <div className="ninjadash-datatable-filter__action">
                            <Button type="primary" size="small" onClick={handleSearch} transparented>Submit</Button>
                        </div>      
                    </div>
                    :
                    <div className="ninjadash-datatable-filter__left">
