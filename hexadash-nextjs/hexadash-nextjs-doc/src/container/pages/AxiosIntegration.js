...
`
              ...
              <Cards headless>
                <div className="ninjadash-template-documentation">
                    <h2>Axios Setup</h2>
                    <p>Then we create Axios Instance. we can find the instancees for <strong>GET,</strong> <strong>POST,</strong> <strong>PATCH,</strong> <strong>PUT</strong> at <code>src/config/dataService/dataService.tsx</code>.</p>
                    <h2>Redux Setup</h2>
                    <p className="mb-0">After the avobe setup we will do our redux setup.</p>
                    <p className="mb-0">At first create actio to <code>/src/redux/crud/axios/actionCreator.tsx</code>.</p>
...
`
                    ...
                    <p className="mb-0">Then we add action at <code>/src/redux/crud/axios/action.tsx</code>.</p>
                    <div className="docs-highlighter mb-35">
                        <pre>
                            <code className="language-javascript">
{
...
`
                    ...
                    <p className="mb-0">Then we add reducer at <code>/src/redux/crud/axios/reducers.tsx</code>.</p>
                    <div className="docs-highlighter mb-35">
                        <pre>
                            <code className="language-javascript">
{
