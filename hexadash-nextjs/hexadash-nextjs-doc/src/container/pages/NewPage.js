            ...
            <Col md={18} xs={24}>
              <Cards headless>
                <div className="ninjadash-template-documentation">
                    ...
                    <p className="mb-0">1. Create page component <code>src/pages/MyPage.tsx</code></p>
...
`
                    ...
                    <p className="mt-35 mb-0">2. Then update the menu item <code>src/layout/MenuItems.tsx</code></p>
...
const items = [
    getItem(
        <Link onClick={toggleCollapsed} href={'/MyPage'}>
            My Page
        </Link>, 
        'page-key', 
        null
