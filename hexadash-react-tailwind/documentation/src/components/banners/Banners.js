...
const PageHeaderBanner = () => {
  return (
    <BannerWrapper className="ninjadash-top-banner">
      <Cards headless>
        <PageHeader className="theme-wide">
          <img src={require('../../static/img/banner/header-banner.png')} alt="" />
          <figcaption>
            <h2 className="ninjadash-top-banner__title">Welcome To Demo Dashboard</h2>
            <p className="ninjadash-top-banner__text">
