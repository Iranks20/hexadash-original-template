    ...
    .ant-skeleton{
        &.ant-skeleton-active{
            .ant-skeleton-content {
                .ant-skeleton-title{
                    background: linear-gradient(90deg, ${({ theme }) => theme[theme.mainContent]['border-color-default']} 25%, ${({ theme }) => theme[theme.mainContent]['border-color-secondary']} 37%, ${({ theme }) => theme[theme.mainContent]['border-color-default']} 63%);
    ...
    .ant-checkbox{
        ...
        &.ant-checkbox-checked{
            ...
            .ant-checkbox-inner{
                ...
                &:after{
                    top: 44%;
                    border-color: ${({ theme }) => theme[theme.mainContent]['white-text']};
                }
            }
        }
    ...
    table{
        ...
        tbody{
            >tr{
                &:not(:last-child){
                    td{
                         border-bottom: 1px solid ${({ theme }) => theme[theme.mainContent]['border-color-secondary']} !important;
                    }
                 }
                 &:hover{
                     td{
