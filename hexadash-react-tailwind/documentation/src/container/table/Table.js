...
import { Main, GlobalUtilityStyle } from '../styled';
import SaleByLocation from '../dashboard/overview/index/SalesByLocation';
import GeneratedRevenue from '../dashboard/overview/demoSeven/RevenueGenerated';
...
function Tables() {
  ...
  return (
    <>
      ...
      <Main className="bg-transparent px-8 pb-[20px]">
        <Row gutter={15}>
