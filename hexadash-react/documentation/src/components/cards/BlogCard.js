    ...
    <BlogCardStyleWrap>
      <figure className={`ninjadash-blog ninjadash-blog-${theme}`}>
        ...
        <figcaption>
          ...
          <h2 className="ninjadash-blog__title"><Link to="#">{title}</Link></h2>
          ...
          <div className="ninjadash-blog__bottom">
            ...
            <ul className="ninjadash-blog__meta">
              <li className="ninjadash-blog__meta--item">
                <span className="like"><UilHeart /><span>70</span></span>
              </li>
              <li className="ninjadash-blog__meta--item">
                <span className="view"><UilFile /><span>120</span></span>
              </li>
            </ul>
          </div>
        </figcaption>
