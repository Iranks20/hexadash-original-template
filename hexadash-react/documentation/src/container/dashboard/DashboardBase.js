    ...
    <>
      ...
      <Main>
        <Row gutter={15}>
                ...
                <Row gutter={15}>
                  <Col md={5}>
                    <Palette
                      ...
                      content
                      direction="90deg"
                      colorCode={[themeColor['secondary-color'], "#00E4EC"]}
                    >
          ...
          <Col xs={24}>
            <DashboardBaseStyleWrap>
              <Cards headless title="Buttons" size="large">
                <Row gutter={15}>
                  <Col md={8}>
                    <Button type="primary" size="extra-small" style={{ marginRight: '10px', marginBottom: '30px' }} raised>
                      Extra Small
                    </Button>
                    ...
                    <Button outlined type="primary" size="extra-small" style={{ marginRight: '10px', marginBottom: '30px' }}>
                      Extra Small
                    </Button>
                    <Button outlined type="primary" size="small" style={{ marginRight: '10px', marginBottom: '30px' }}>
                      Small
                    </Button>
                    <Button outlined type="primary" size="default" style={{ marginRight: '10px', marginBottom: '30px' }}>
                      Normal
                    </Button>
                    <Button outlined type="primary" size="large" style={{ marginRight: '10px', marginBottom: '30px' }} transparented>
                      Large Button
                    </Button>
                    <Button type="primary" size="extra-small" style={{ marginRight: '10px', marginBottom: '30px' }} transparented>
                      Extra Small
                    </Button>
                    <Button type="primary" size="small" style={{ marginRight: '10px', marginBottom: '30px' }} transparented>
                      Small
                    </Button>
                    <Button type="primary" size="default" style={{ marginRight: '10px', marginBottom: '30px' }} transparented>
                      Normal
                    </Button>
          ...
          <Col xs={24}>
            <DashboardBaseStyleWrap>
              <Cards headless title={<span>Typography <span className="color-primary">Jost</span></span>} size="large">
