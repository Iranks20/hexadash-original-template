		...
		<ul>
				...
				<ul class="megaMenu-wrapper megaMenu-dropdown">
					<li>
						<ul>
							...
							<li>
								<a href="/chat">
									<InlineSVG src={'/img/svg/message-square.svg'} />
							...
							<li class="has-subMenu-left">
								<a href={'#'}>
									<InlineSVG src={'/img/svg/shopping-cart.svg'} />
							...
							<li class="has-subMenu-left">
								<a href={'#'}>
									<InlineSVG src={'/img/svg/user-check.svg'} />
			...
			<li class="has-subMenu">
				...
				<ul class="subMenu">
					...
					<li class="has-subMenu-left">
						<a href={'#'}>
							<InlineSVG src={'/img/svg/grid.svg'} />
					...
					<li class="has-subMenu-left">
						<a href={'#'}>
							<InlineSVG src={'/img/svg/bar-chart-2.svg'} />
					...
					<li class="has-subMenu-left">
						<a href={'#'}>
							<InlineSVG src={'/img/svg/disc.svg'} />
					...
					<li class="has-subMenu-left">
						<a href={'#'}>
							<InlineSVG src={'/img/svg/server.svg'} />
					...
					<li class="has-subMenu-left">
						<a href={'#'}>
							<InlineSVG src={'/img/svg/square.svg'} />
						...
						<ul>
							<li>
								<a href="/pages/changelog">
									...
									<span class="badge badge-info-10 menuItem rounded-pill">1.0.0</span>
								</a>
							</li>
							<li>
			...
			<li class="mega-item has-subMenu">
				...
				<ul class="megaMenu-wrapper megaMenu-wide">
					...
					<li>
						...
						<ul>
							<li>
								<a href="/components/typography">Dashboard Base</a>
							</li>
							<li>
							...
							<li>
								<a href="/components/draggable-list">Drag & Drop</a>
							</li>
							<li>
