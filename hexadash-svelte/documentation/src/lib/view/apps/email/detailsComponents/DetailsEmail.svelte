...
<div class="mail-read-content">
    ...
    <div class="mail-reply">
                    ...
                    <div class="mdc__head d-flex justify-content-between">
                        <div class="mdc__author media">
                            ...
                            <div class="mdc__excerpt">
                                <span class="date-meta">Jan 2, 2022, 5:22 PM</span>
                                <a href="/">
                                    <InlineSVG src={starIcon}/>
                                </a>
                                <a href="/">
                                    <InlineSVG src={cornerLeft}/>
                                </a>
                                <a href="/">
                                    <InlineSVG src={moreVerticalIcon}/>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mail-reply__action d-flex">
            <a href="/" class="btn btn-outline-lighten btn-md"><InlineSVG src={cornerLeft} /> Reply</a>
            <a href="/" class="btn btn-outline-lighten btn-md"><InlineSVG src={cornerRight} />Forword</a>
        </div>
