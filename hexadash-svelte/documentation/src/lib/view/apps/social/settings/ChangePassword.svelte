						...
						<Form>
							...
							<FormGroup class="mb-1">
								...
								<div class="button-group d-flex flex-wrap pt-45 mb-35">
									<Button color="primary" size="default" class="btn-squared me-15 text-capitalize"
										>Save Changes
									</Button>

									<Button class="btn-squared fw-400 text-capitalize btn btn-light btn-default">cancel</Button>
								</div>
							</FormGroup>
						</Form>
					</div>
