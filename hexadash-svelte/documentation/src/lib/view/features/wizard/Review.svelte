...
<div
	class="global-shadow wizard6 checkout-review p-sm-50 px-20 p-20 bg-white w-100"
>
		...
		<Col xl={8}>
			<div class="checkout-progress-indicator content-center">
				<div class="checkout-progress w-100">
					...
					<div class="current"><InlineSVG src={'/img/svg/green.svg'} /></div>
					<div class="step completed" id="2">
						<span> <InlineSVG src={'/img/svg/address-success.svg'} /> </span>
						<span>Shipping Address</span>
					</div>
					<div class="current"><InlineSVG src={'/img/svg/green.svg'} /></div>
					<div class="step completed" id="3">
						<span><InlineSVG src={'/img/svg/155-credit-card-success.svg'} /></span>
						<span>Payment Method</span>
					</div>
					<div class="current"><InlineSVG src={'/img/svg/checkoutin.svg'} /></div>
					<div class="step current" id="4">
						<span><InlineSVG src={'/img/svg/024-like-active.svg'} /></span>
				...
				<CardBody class="mb-30 bg-white bg-shadow radius-xl px-sm-30 px-15 pt-25 mb-30">
					<div class="review-order__title mb-30">
						...
						<button
							...
							><InlineSVG src={'/img/svg/edit.svg'} /> edit</button
						>
					</div>
					...
					<button
						...
						><InlineSVG src={'/img/svg/plus.svg'} /> Add new address</button
					>
				</CardBody>
				<CardBody class="mb-30 bg-white bg-shadow radius-xl px-sm-30 px-15 pt-25  mb-30">
					<div class="review-order__title mb-30">
					...
					<button
						type="submit"
						class="border-0 review-order__title-btn shadow-none bg-transparent color-info content-center fs-13 fw-500 p-0"
						><InlineSVG src={'/img/svg/plus.svg'} /> Add new card
					</button>
				</CardBody>
