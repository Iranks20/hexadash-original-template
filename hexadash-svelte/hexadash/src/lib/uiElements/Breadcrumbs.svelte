<script>
	import { Row, Col, Card, CardHeader, CardBody, Breadcrumb, BreadcrumbItem } from '@sveltestrap/sveltestrap';
</script>
...
<Row>
	<Col lg={6}>
		...
		<Card class="card-default card-md mb-4">
			...
			<CardBody>
				<ul class="custom-breadcrumb nav">
		...
		<Card class="card-default card-md mb-4">
			<CardHeader>
				<h6>Breadcrumb with dropdown menu</h6>
			</CardHeader>
			<CardBody>
				<ul class="custom-breadcrumb nav">
					<li class="custom-breadcrumb__item">
