							...
							>
								<td>
									<div class="item d-flex align-items-center">
										<img class="svg" alt="" src={'/img/svg/move.svg'} />
...
<style lang="scss">
	...
	:global {
		...
		.drag-drop-wrap .draggable-item .item svg ~ img,
		.drag-drop-wrap .draggable-item .item svg ~ svg,
		.drag-drop-wrap .draggable-item .table-actions a svg ~ img,
		.drag-drop-wrap .draggable-item .table-actions a svg ~ svg{
			display: none;
		}
	}
