...
// @ts-nocheck
	...
	import { Accordion, AccordionItem, Col, Row } from '@sveltestrap/sveltestrap';
							...
							<div class="border-0 dm-collapse dm-accordion">
								<Accordion>
									{#each collapseItem as item}
										<AccordionItem class="dm-collapse-item" active={item.activeIcon}>
											<div class="dm-collapse-item__header" slot="header">
												<div class="item-link">
											...
											<div class="dm-collapse-item__body">
							...
							<div class="border-0 dm-collapse dm-accordion">
								<Accordion>
									{#each faqItem as item}
										<AccordionItem class="dm-collapse-item" active={item.activeIcon}>
											<div class="border-bottom-0 mb-0 dm-collapse-item__header" slot="header">
												<div
													class="item-link"
												>
													<div class="dm-collapse-title">
