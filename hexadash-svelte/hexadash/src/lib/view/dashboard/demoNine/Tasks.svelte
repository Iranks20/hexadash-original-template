...
<Card class="border-0 px-25 task-list h-100">
			...
			<ul class="card-tab-links nav">
				...
				<li>
					<a
						...
						href={'#'}
						class={taskTab === 'completed' ? 'active' : ''}
					>
						Month
					</a>
				</li>
	...
	<CardBody>
		<TaskApp header="" description={false} taskStatus={taskTab} taskLimit="5" />
	</CardBody>
</Card>
