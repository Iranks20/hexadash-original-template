...
<div>
	<Container fluid>
		<Row class="justify-content-center">
			...
			<Col lg={8} class="mb-30">
				<div class="job-details-card">
                    <div class="job-details-card__top flex-wrap">
                        <div class="job-item__image">
                            <a href="#">
                                <img class="job-item__image-img img-fluid" src="/img/job/stats.png" alt="digital-chair">
                            </a>
			...
			<Col lg={4} class="mb-30">
				<div class="job-details-widget">
                    ...
                    <a href="/job/job-apply" class="btn btn-primary w-100">Apply Now</a>
                </div>
			</Col>
		</Row>
	</Container>
