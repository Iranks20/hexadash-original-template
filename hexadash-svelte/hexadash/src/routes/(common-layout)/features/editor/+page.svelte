<script>
	import { Container, Row, Col, Input, Card, CardHeader, CardBody } from '@sveltestrap/sveltestrap';
						...
						<form action={'#'}>
							<div class="dm-mailCompose__header d-flex justify-content-between align-items-center">
								...
								<div class="dm-mailCompose__action">
									<a href={'#'}>
										<img class="svg" alt="" src={'/img/svg/maximize-2.svg'} />
									</a>
							...
							<div class="dm-mailCompose__footer d-flex justify-content-between align-items-center">
								...
								<div class="footer-right">
									<a href={'#'} class="btn-remove">
										<img class="svg" alt="" src={'/img/svg/trash-2.svg'} /></a
									>
								</div>
							</div>
						</form>
