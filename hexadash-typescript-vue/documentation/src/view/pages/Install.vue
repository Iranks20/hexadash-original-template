        ...
        <a-col :xs="24">
          <sdCards headless>
            <div class="ninjadash-template-documentation">
              ...
              <p>
                We used Vite JS which is a build tool that allows developers to create modern web applications and libraries quickly and easily. It leverages the native ES modules feature in modern browsers to provide fast, optimized builds that are ideal for development and production environments.
              </p>
              <p>
                In addition, for better understanding on how to install Vue JS application along with Vite JS, we suggest you to go through the
              ...
              <ul>
                ...
                <li>
                  Now run <strong>yarn dev</strong>, it should open up http://127.0.0.1:_port_ on
                  your browser
                </li>
              </ul>
              ...
              <sdAlert closable message="" type="success">
                <template #description>
                  ...
                  <p>
                    Remove node_module and package-lock.json/yarn.lock file and again do
                    <strong>npm install</strong>
                  </p>
                  <p>
                    You can again download theme from Themeforest and then again
                    run
                  </p>
                  <p>
...
export default defineComponent({
  ...
  setup() {
    const setPath = ref(`VITE_SUB_ROUTE="/YOUR/PATH`);
