            ...
            <sdCards headless>
              <div class="ninjadash-template-documentation">
                ...
                <p class="mb-0">
                  ...
                  <code>/translation.ts</code>
                </p>
                <p class="mb-0">
                  2) Update the below code in the
                  <code>src/i18n/config.ts</code>
                </p>
                ...
                <p>
                  ...
                  <code>src/components/utilities/auth-info/info.ts</code>
                </p>
...
<NavAuth>
  ...
  <router-link @click="() => onFlagChangeHandle('germany')" to="#">
    <img
      :src="require('../../../assets/img/flag/germany.png')"
      alt=""
    />
    <span>Germany</span>
  </router-link>
  <router-link @click="() => onFlagChangeHandle('spain')" to="#">
    <img
      :src="require('../../../assets/img/flag/spain.png')"
      alt=""
    />
    <span>Spain</span>
  </router-link>
  <router-link @click="() => onFlagChangeHandle('bengali')" to="#">
    <img
      :src="require('../../../assets/img/flag/bengali.png')"
      alt=""
    />
    <span>Bengali</span>
  </router-link>
