<template>
  <div>
    <sdPageHeader title="Chart Js" class="ninjadash-page-header-main">
    </sdPageHeader>
    <Main>
      <a-row :gutter="25">
...
<template>
    <Main>           
        <sdGoogleBasicBarChart 
          ...
          width="100%" 
          :height="300" 
          title="Population of Largest U.S. Cities" chartArea="50%"
        />       
    </Main>
</template>
<script>
...
<template>
    <Main>
       <sdBubbleChart :data="chartData" width="100%" :height="300" />
    </Main>
</template>
      `,
      stackedChart: `
