  ...
  >
    ...
    <a-sub-menu key="dev">
      ...
      <a-menu-item @click="toggleCollapsed" key="folder-structure">
        <router-link to="/dev/folder-structure"> Folder Structure </router-link>
      </a-menu-item>
      ...
      <a-menu-item @click="toggleCollapsed" key="theme-config">
        <router-link to="/dev/theme-config"> Theme Configuration </router-link>
      </a-menu-item>
    ...
    <a-menu-item @click="toggleCollapsed" key="firebase">
      <template #icon>
        <unicon name="server"></unicon>
      </template>
      <router-link to="/firebase"> Firebase Integration </router-link>
    </a-menu-item>
