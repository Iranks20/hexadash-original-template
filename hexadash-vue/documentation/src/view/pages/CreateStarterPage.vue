          ...
          <sdCards headless>
            <div class="ninjadash-template-documentation">
              ...
              <p class="mb-0">
                ...
                <code>src/containers/pages/MyPage.vue</code>
              </p>
              <prism-editor
                :readonly="true"
              ...
              <p class="mb-0">
                2. Update the routes <code>src/routes/admin/pages.js</code>
              </p>
              <prism-editor
                :readonly="true"
                class="my-editor height-100"
...
const routes = [
  {
    path: '/new-page',
    name: 'new-page',
    component: () => import(/* webpackChunkName: "NewPage" */ '@/view/pages/NewPage.vue'),
  },
];
