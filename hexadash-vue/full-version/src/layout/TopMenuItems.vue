      ...
      <ul>
        <li class="has-subMenu">
          ...
          <ul class="subMenu">
            ...
            <li @click="addParentActive">
              <router-link :to="`/demo-six`">Demo 6</router-link>
            </li>
            <li @click="addParentActive">
              <router-link :to="`/demo-seven`">Demo 7</router-link>
            </li>
            <li @click="addParentActive">
              <router-link :to="`/demo-eight`">Demo 8</router-link>
            </li>
            <li @click="addParentActive">
              <router-link :to="`/demo-nine`">Demo 9</router-link>
            </li>
          </ul>
        </li>
          ...
          <ul class="subMenu">
            ...
            <li @click="addParentActive">
              <router-link :to="`/app/kanban`">
                <SvgConverter
                  class="ninjadash_menu-item-icon"
