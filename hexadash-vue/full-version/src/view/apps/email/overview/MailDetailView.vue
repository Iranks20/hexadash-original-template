      ...
      <a-row :gutter="15">
        <a-col>
          <MessageDetails>
            ...
            <div
              class="message-box d-flex justify-content-between align-items-center"
            >
            ...
            <div class="message-attachments">
              ...
              <figure>
                <div class="attachment-image">
                  <img
                    :src="require('../../../../static/img/email/1.png')"
                    alt=""
                  />
                </div>
                <div class="attachment-hover">
              ...
              <figure>
                <div class="attachment-image">
                  <img
                    :src="require('../../../../static/img/email/3.png')"
                    alt=""
                  />
                </div>
                <div class="attachment-hover">
              ...
              <figure>
                <div class="attachment-image">
                  <img
                    :src="require('../../../../static/img/email/4.png')"
                    alt=""
                  />
                </div>
                <div class="attachment-hover">
              ...
              <figure class="reply-view__content d-flex">
                ...
                <figcaption>
                  ...
                  <p>
                    ...
                    diam nonumy eirmod tempor inviduntLorem ipsum dolor...
                  </p>
                </figcaption>
              </figure>
          ...
          <MessageReply>
            <nav>
              <ul>
                <li>
                  <router-link
                    :to="`/app/mail-single/${params.id}/replay`"
                    class="reply-link"
                  >
                ...
                <li>
                  <router-link
                    :to="`/app/mail-single/${params.id}/forward`"
                    class="reply-link"
                  >
