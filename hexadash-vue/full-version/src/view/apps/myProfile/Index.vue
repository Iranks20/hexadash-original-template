<template>
  <sdPageHeader title="My Profile" class="ninjadash-page-header-main">
  </sdPageHeader>
...
const UserCards = defineAsyncComponent(() =>
  import("../../pages/overview/UserCard")
);
const CoverSection = defineAsyncComponent(() =>
  import("./overview/CoverSection")
);
