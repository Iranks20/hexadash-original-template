      ...
      <ul class="activity-list">
        <li class="activity-list__single">
          <span class="activity-icon primary">
            <unicon name="inbox" width="14"></unicon>
          </span>
          <div class="activity-content">
            <div class="activity-info">
              <img :src="require('@/static/img/chat-author/t1.jpg')" alt="" />
              <p>
                <span class="inline-text color-primary">James</span> Send you a
                message
        ...
        <li class="activity-list__single">
          <span class="activity-icon secondary">
            <unicon name="upload" width="14"></unicon>
          </span>
          <div class="activity-content">
            <div class="activity-info">
              <img :src="require('@/static/img/chat-author/t2.jpg')" alt="" />
              <p>
                <span class="inline-text color-primary">Adam </span>upload
        ...
        <li class="activity-list__single">
          <span class="activity-icon success">
            <unicon name="signout" width="14"></unicon>
          </span>
          <div class="activity-content">
            <div class="activity-info">
              <img :src="require('@/static/img/chat-author/t3.jpg')" alt="" />
              <p>
                <span class="inline-text color-primary">Mumtahin</span> has
                registered
                <span class="hour">5 hours ago</span>
              </p>
            </div>
        ...
        <li class="activity-list__single">
          <span class="activity-icon info">
            <unicon name="at" width="14"></unicon>
          </span>
          <div class="activity-content">
            <div class="activity-info">
