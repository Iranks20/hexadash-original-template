<template>
  <div>
    <sdPageHeader class="ninjadash-page-header-main" title="Notification">
    </sdPageHeader>
    <Main>
      <a-row :gutter="25">
        <a-col :md="12" :xs="24">
          <sdCards title="Basic">
            <sdButton type="primary" size="sm" @click="openNotification">
        ...
        <a-col :md="12" :xs="24">
          <sdCards title="Custom Icon">
            <sdButton type="primary" size="sm" @click="openNotificationIcon">
              Open the notification box
            </sdButton>
          </sdCards>
        </a-col>
  ...
  methods: {
    ...
    openNotificationIcon() {
      Notification.open({
        ...
        description:
          "This is the content of the notification. This is the content of the notification. This is the content of the notification.",
        icon: <unicon name="smile" width="14" style="fill: #108ee9"></unicon>,
      });
    },
