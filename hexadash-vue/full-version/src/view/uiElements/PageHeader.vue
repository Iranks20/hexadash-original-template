<template>
  <div>
    <sdPageHeader class="ninjadash-page-header-main" title="PageHeader">
    </sdPageHeader>
    <Main>
      <a-row :gutter="25">
        <a-col :md="24" :xs="24">
          <sdCards title="Basic Header">
            <PageHeaderWrapper>
              <sdPageHeader title="Title" subTitle="This is a subtitle" />
            </PageHeaderWrapper>
          </sdCards>
        </a-col>
        <a-col :md="24" :xs="24">
              ...
              >
                <template v-slot:buttons>
                  <a-space>
                    ...
                    <sdButton size="sm" type="primary" :outlined="true">
                      Primary
                    </sdButton>
                  </a-space>
                </template>
