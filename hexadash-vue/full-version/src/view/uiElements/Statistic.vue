<template>
  <div>
    <sdPageHeader class="ninjadash-page-header-main" title="Statistic">
    </sdPageHeader>
    <Main>
      <a-row :gutter="25">
        <a-col :md="12" :xs="24">
          <sdCards title="Basic" caption="The simplest use of Statistic">
            <a-row :gutter="16">
              ...
              <a-col :span="12">
                <div class="ninjadash-ac-balance">
                  <a-statistic
