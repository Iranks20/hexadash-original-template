<template>
  <div>
    <sdPageHeader class="ninjadash-page-header-main" title="Timeline">
    </sdPageHeader>
    <Main>
      <a-row :gutter="25">
        <a-col :lg="12" :xs="24">
            ...
            <TimeLinePointerIconWrap>
              <a-timeline>
                <a-timeline-item class="timeline-primary">
                  <template #dot>
                    <SwRocket size="20" :color="themeColor['primary-color']" />
                  </template>
                  <h3>02:30 PM</h3>
                  <p>
                ...
                <a-timeline-item class="timeline-info">
                  <template #dot>
                    <SwShieldCheck size="20" :color="themeColor['info-color']"
                  /></template>
                  <h3>02:30 PM</h3>
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and
                ...
                <a-timeline-item class="timeline-warning">
                  <template #dot>
                    <SwPenTool size="24" :color="themeColor['warning-color']" />
                  </template>
                  <h3>02:30 PM</h3>
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and
                ...
                <a-timeline-item class="timeline-pink">
                  <template #dot>
                    <SwNotification size="17" color="#FF69A5" />
                  </template>
                  <h3>02:30 PM</h3>
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and
                ...
                <a-timeline-item class="timeline-success">
                  <template #dot>
                    <SwUsers size="21" :color="themeColor['success-color']" />
                  </template>
                  <h3>02:30 PM</h3>
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and
                ...
                <a-timeline-item class="timeline-danger">
                  <template #dot>
                    <SwLayers size="21" :color="themeColor['danger-color']" />
                  </template>
                  <h3>02:30 PM</h3>
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and
                ...
                <a-timeline-item class="timeline-primary">
                  <template #dot>
                    <SwPicture size="21" :color="themeColor['primary-color']" />
                  </template>
                  <h3>02:30 PM</h3>
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and
          ...
          <TimelineNormalWrap>
            <sdCards title="Alternate">
              <a-timeline mode="alternate">
                <a-timeline-item class="custom-dot"
                  >Create a services site 2015-09-01</a-timeline-item
                >
            ...
            <sdCards title="Timeline 1">
              <a-timeline>
                <a-timeline-item class="active">
                  ...
                  <div
                    class="timeline-content-inner align-center-v justify-content-between"
                  >
              ...
              <a-timeline mode="alternate">
                <a-timeline-item>
                  ...
                  <div class="content-box">
                    <p>
                      Lorem Ipsum is simply dummy text of theprintng and
