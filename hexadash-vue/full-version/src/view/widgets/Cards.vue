<template>
  <div>
    <sdPageHeader title="Widgets Cards" class="ninjadash-page-header-main">
    ...
    <Main>
      <a-row :gutter="25">
        ...
        <a-col
          ...
          :xs="24"
        >
          <GalleryCards :item="item" :index="id" />
        </a-col>
        <a-col
          ...
          :xs="24"
        >
          <sdCards headless v-if="user.id <= 4">
