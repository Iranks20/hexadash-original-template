        ...
        .ant-table-tbody{
            ...
            .ant-table-row{
                &:hover{
                    ...
                    td{
                        background: ${({ theme }) => theme[theme.mainContent]['dark-background']}; !important;
                    }
                    .table-action{
                        button{
                            background: #FF4D4F15;
...
const WizardWrapper = Styled.div`
   ...
   .ninjadash-finish-order{
       ...
       h6{
            margin-bottom: 16px;
            color: ${({ theme }) => theme[theme.mainContent]['darks-text']};
       }
       .ant-checkbox{
           &:hover{
               .ant-checkbox-inner{
...
const WizardSix = Styled.div`
    ...
    .ninjadash-review-order{
        position: relative;
        .ninjadash-review-order__single .ant-card .ant-card-body{
            @media only screen and (max-width: 767px) {
                padding: 15px  !important;
            }
        }
